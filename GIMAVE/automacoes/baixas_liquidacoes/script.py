...
def apagar_Campo(driver, elemento_id):
    """
...
if login_tela_encontrada: # Se a imagem principal de login foi encontrada (True)
    ...
    digitar_entrada_com_TAB(navegador, "00110101", 1)
...
# Clicar em Favorito
esperar_e_clicar(navegador, 'COMP3065')
time.sleep(5)

#Contas a Receber 
esperar_e_clicar(navegador, 'COMP3010')
time.sleep(5)
...
def processar_linha(linha):
    ...
    try:
        ...
        # Inserir descontos
        inserir_Com_Python(navegador, 'COMP6059', Desconto)
        time.sleep(2)
       
        multa ="0,00"
        # Inserir Multa
        inserir_Com_Python(navegador, 'COMP6061', multa)
        time.sleep(2)
